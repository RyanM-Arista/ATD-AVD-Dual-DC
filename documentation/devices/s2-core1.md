...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.202/24 | 192.168.0.1 |
...
| -------------- | ------------------- | --- | -------------- | -------------- | -------------- | ---------- |
| gzip | 192.168.0.5 | MGMT | key,atd-lab | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | True |
...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=192.168.0.5 -cvauth=key,atd-lab -cvvrf=MGMT -disableaaa -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -ingestexclude=/Sysdb/cell/1/agent,/Sysdb/cell/2/agent -taillogs
   no shutdown
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.2.8.1/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.2.9.1/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.2.8.1/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.2.9.1/32
```
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.2.8.0/24 eq 32 |
| 20 | permit 10.2.9.0/24 eq 32 |
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   seq 10 permit 10.2.8.0/24 eq 32
   seq 20 permit 10.2.9.0/24 eq 32
```
